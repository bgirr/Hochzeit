...
public partial class FatButton: Fuse.Controls.Panel
{
    ...
    void InitializeUX()
    {
        ...
        temp_Text_inst = new Hochzeit_FuseControlsButtonBase_Text_Property(temp, __selector0);
        var temp2 = new global::Fuse.Reactive.Property(temp1, Hochzeit_accessor_FatButton_Text.Singleton);
        this_Text_inst = new Hochzeit_FatButton_Text_Property(this, __selector0);
